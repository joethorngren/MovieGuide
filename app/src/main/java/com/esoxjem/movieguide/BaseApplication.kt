...
class BaseApplication : Application(), HasActivityInjector {
    ...
    var movieDetailsFragmentSubcomponent: MovieDetailsFragmentSubcomponent? = null
    var moviesListingFragmentSubcomponent: MoviesListingFragmentSubcomponent? = null
