...
class MovieDetailsFragment : Fragment(), MovieDetailsView, HasSupportFragmentInjector {

    @Inject lateinit var movieDetailsPresenter: MovieDetailsPresenter

    @BindView(R.id.movie_poster) lateinit var poster: ImageView
    @BindView(R.id.collapsing_toolbar) lateinit var collapsingToolbar: CollapsingToolbarLayout
    @BindView(R.id.movie_name) lateinit var title: TextView
    @BindView(R.id.movie_year) lateinit var releaseDate: TextView
    @BindView(R.id.movie_rating) lateinit var rating: TextView
    @BindView(R.id.movie_description) lateinit var overview: TextView
